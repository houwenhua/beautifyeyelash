...
<body style="padding:0px;">
	...
	<div id="tb" style="padding:5px;">
		...
		<div style="padding:5px;">
			消费者姓名：<input type="text" name="vipname" class="textbox"/>
			服务类型：<input type="text" name="servicename" class="textbox"/>
			服务人姓名：<input type="text" name="waitername" class="textbox"/>
