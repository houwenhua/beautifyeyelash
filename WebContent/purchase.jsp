...
<body style="padding:0px;">
	...
	<div id="tb" style="padding:5px;">
		<div>
			...
			<a href="#" iconCls="icon-add" class="easyui-linkbutton" plain="true" onclick="obj.adddetail();">采购详情</a>
		</div>
		<div id="dd"></div> 
		<div style="padding:5px;">
		          采购员：<input type="text" name="purchasename" class="textbox"/>
			供货商：<input type="text" name="provider" class="textbox"/>
