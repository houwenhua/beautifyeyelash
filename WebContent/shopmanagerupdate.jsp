...
<body>
	<div id="form1" style="width:400px;" class="easyui-panel" title="店长更新">
...
$.ajax({
	url:'shopmanager_queryObject.action',
	type:'POST',
	data:{
		id:id,
	},
	success:function(data){
		...
		$('#store').combobox({
			editable:false,
			url:'shopmanager_queryStore.action',
			valueField: 'storeid',    
		    textField: 'storename',
			...
			if(data==1){
				$.messager.show({
				 ...
				 $.messager.alert('系统提示', '修改成功！！！', 'info', function(){
					 parent.reloadDatagridShopManager("店长信息");
				     closeTab('店长更新');
				 });
			}else{
