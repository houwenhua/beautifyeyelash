...
<body style="padding:0px;">
	...
	<div id="tb" style="padding:5px;">
		<div>
			...
			<a href="#" iconCls="icon-remove" class="easyui-linkbutton" plain="true" onclick="obj.update();">修改</a>
			<a href="#" iconCls="icon-edit" class="easyui-linkbutton" plain="true" onclick="obj.edit()">查看详情</a>
		</div>
		<div id="dd"></div> 
		<div style="padding:5px;">
			开始时间：<input editable="false" type="text" name="startdate" class="easyui-datebox"/>
			结束时间：<input editable="false" type="text" name="enddate" class="easyui-datebox"/>
...
<script type="text/javascript" src="js/goodsrecord.js"></script>
</html>